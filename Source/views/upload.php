...
<form action="<?php echo $url; ?>" method="post" enctype="multipart/form-data">
    <label for="video_upload"><?php echo $lang::getItem('upload_vido-upload-label'); ?></label>
    <input type="file" id="video_upload" name="video_upload" required>
    <label for="title"><?php echo $lang::getItem('upload_video-title-label'); ?></label>
    ...
    <label for="description"><?php echo $lang::getItem('upload_video-description-label'); ?></label>
